...
Note: 
The parse tree diagrams are saved as ".ps" files in the "results/" direcotry. 
It is necessary to install ImageMagick and use a command to view the saved 
diagrams. Please see the "V. Appendix" section in "P2_Report1_Pipeline.pdf".
